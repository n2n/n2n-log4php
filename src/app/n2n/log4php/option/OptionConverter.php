...
class OptionConverter {
	...
	public static function toBooleanEx($value) {
		...
		throw new \n2n\log4php\LoggerException("Given value [" . var_export($value, true) . "] cannot be converted to boolean.");
	}
	...
	public static function toIntegerEx($value) {
		...
		throw new \n2n\log4php\LoggerException("Given value [" . var_export($value, true) . "] cannot be converted to integer.");
	}
	...
	public static function toPositiveIntegerEx($value) {
		...
		throw new \n2n\log4php\LoggerException("Given value [" . var_export($value, true) . "] cannot be converted to a positive integer.");
	}
	...
	public static function toLevelEx($value) {
		...
		$level = \n2n\log4php\LoggerLevel::toLevel($value);
		if ($level === null) {
			throw new \n2n\log4php\LoggerException("Given value [" . var_export($value, true) . "] cannot be converted to a logger level.");
		}
		return $level;
	}
	...
	public static function toFileSizeEx($value) {
		...
		if (empty($value)) {
			throw new \n2n\log4php\LoggerException("Empty value cannot be converted to a file size.");
		}
		...
		if (!is_string($value)) {
			throw new \n2n\log4php\LoggerException("Given value [" . var_export($value, true) . "] cannot be converted to a file size.");
		}
		...
		throw new \n2n\log4php\LoggerException("Given value [$value] cannot be converted to a file size.");
	}
	...
	public static function toStringEx($value) {
		...
		throw new \n2n\log4php\LoggerException("Given value [" . var_export($value, true) . "] cannot be converted to string.");
	}
