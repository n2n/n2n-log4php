...
class Logger {
	...
	public function trace($message, $throwable = null) {
		$this->log(\n2n\log4php\LoggerLevel::getLevelTrace(), $message, $throwable);
	} 		
	...
	public function debug($message, $throwable = null) {
		$this->log(\n2n\log4php\LoggerLevel::getLevelDebug(), $message, $throwable);
	} 
	...
	public function warn($message, $throwable = null) {
		$this->log(\n2n\log4php\LoggerLevel::getLevelWarn(), $message, $throwable);
	}
	...
	public function isTraceEnabled() {
		return $this->isEnabledFor(\n2n\log4php\LoggerLevel::getLevelTrace());
	}
	...
	public function isFatalEnabled() {
		return $this->isEnabledFor(\n2n\log4php\LoggerLevel::getLevelFatal());
	}
	 ...
	 * @param \n2n\log4php\LoggerAppender $appender The appender to add.
	 */
	 ...
	 * @param mixed $appender an appender name or a {@link \n2n\log4php\LoggerAppender} instance.
	 */
	 ...
	 * @return \n2n\log4php\LoggerLevel or null
	 */
	 ...
	 * @return \n2n\log4php\LoggerLevel The assigned level or null if none is assigned. 
	 */
	 ...
	 *
	 * Use \n2n\log4php\LoggerLevel::getLevelXXX() methods to get a \n2n\log4php\LoggerLevel object, e.g.
	 * <code>$logger->setLevel(\n2n\log4php\LoggerLevel::getLevelInfo());</code>
	 *
	 * @param \n2n\log4php\LoggerLevel $level The level to set, or NULL to clear the logger level.
	 */
	...
	public static function getHierarchy() {
		if(!isset(self::$hierarchy)) {
			self::$hierarchy = new \n2n\log4php\LoggerHierarchy(new LoggerRoot());
		}
	 ...
	 *   
	 * @param string|\n2n\log4php\LoggerConfigurator $configurator A custom 
	 * configurator class: either a class name (string), or an object which 
	 * implements the \n2n\log4php\LoggerConfigurator interface. If left empty, the default
	 ...
	 * 
	 * @param string|\n2n\log4php\LoggerConfigurator $configurator The configurator class 
	...
	private static function getConfigurator($configurator = null) {
		...
		if (is_string($configurator)) {
			if (!class_exists($configurator)) {
				throw new \n2n\log4php\LoggerException("log4php: Specified configurator class [$configurator] does not exist. Reverting to default configurator.", E_USER_WARNING);
				return new \n2n\log4php\configurator\ConfiguratorDefault();
			}
