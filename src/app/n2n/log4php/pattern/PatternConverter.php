 ...
 * @since 0.3
 */
abstract class PatternConverter {
	 ...
	 * @var \n2n\log4php\formatting\FormattingInfo
	 */
	 ...
	 * @param \n2n\log4php\logging\LoggingEvent $event Event to be formatted.
	 */
